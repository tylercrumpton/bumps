...
def render(message, file=""):
    ...
    if appearance == "GenericBump":
        ...
        for i in range(len(sections)):
            ...
            filename = file + " - IMG" + str(i + 1).zfill(4) + ".png"
    ...
    if appearance == "DearDCTV":
        ...
        for i in range(len(sections)):
            ...
            if len(lines) == 0:
                print(
                    "This section is just a blank line, so we will just increment the offset and move on without writing anything"
                )
